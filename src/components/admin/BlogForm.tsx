...
import { adminBtnOutline, adminBtnPrimary, adminInputBase } from '@/lib/admin/styles';
...
export function BlogForm({
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-6">
      <Card title="Informasi Artikel">
        <div className="flex flex-col gap-4">
          <div className="flex flex-col gap-1.5">
            <label htmlFor="blog-title" className="text-sm font-semibold text-foreground">
              Judul
            </label>
            <input id="blog-title" {...register('title')} className={adminInputBase} />
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="flex flex-col gap-1.5">
              <label htmlFor="blog-slug" className="text-sm font-semibold text-foreground">
                Slug{' '}
                <span className="font-normal text-neutral-400">(kosongkan untuk otomatis)</span>
              </label>
              <input id="blog-slug" {...register('slug')} className={adminInputBase} />
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <input id="blog-author" {...register('author')} className={adminInputBase} />
          ...
          <div className="grid gap-4 sm:grid-cols-2">
            <div className="flex flex-col gap-1.5">
              <label htmlFor="blog-tags" className="text-sm font-semibold text-foreground">
                Tag{' '}
                <span className="font-normal text-neutral-400">(tekan Enter untuk menambah)</span>
              </label>
              <div className="flex flex-wrap items-center gap-1.5 rounded-lg border border-neutral-300 bg-white px-2 py-1.5 focus-within:border-brand">
                {tags.map((tag) => (
                  <span
                    key={tag}
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <select id="blog-status" {...register('status')} className={adminInputBase}>
      ...
      <Card>
        {errors.root ? <p className="mb-3 text-sm text-red">{errors.root.message}</p> : null}
